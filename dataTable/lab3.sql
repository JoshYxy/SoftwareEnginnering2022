...
CREATE TABLE `building`  (
  ...
  INDEX `abbr_name`(`room_name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `class_course`  (
  `tea_num` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  INDEX `fk_college_course`(`course_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `classroom`  (
  ...
  CONSTRAINT `fk_class_building` FOREIGN KEY (`building`) REFERENCES `building` (`room_name`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of classroom
-- ----------------------------
INSERT INTO `classroom` VALUES (1, 'H2', '110', NULL);
INSERT INTO `classroom` VALUES (2, 'H3', '106', NULL);
...
INSERT INTO `college` VALUES (5, '计算机科学yu技术');
...
CREATE TABLE `course`  (
  ...
  `course_num` varchar(0) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES (1, '软件工程', NULL, '40', '4', '信息隐藏的好处', 5, '20000002', 3, '4-5', 1);
...
-- Records of major
-- ----------------------------
INSERT INTO `major` VALUES (1, '保密技术', '计算机科学yu技术');
INSERT INTO `major` VALUES (2, '计算机科学与技术', '计算机科学yu技术');
INSERT INTO `major` VALUES (3, '软件工程', '计算机科学yu技术');
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('student', '220001', '533298200110034568', '小罗', '123456', '19012127754', '220001@fudan.edu.cn', 'studying', '软件工程', '计算机科学yu技术');
INSERT INTO `student` VALUES ('student', '220002', '210321200111034562', '小俞', '123456', '17869897754', '220002@fudan.edu.cn', 'studying', '计算机科学与技术', '计算机科学yu技术');
INSERT INTO `student` VALUES ('student', '220003', '311321200206070023', '小李', 'xlxlll', '13111702898', NULL, 'studying', '软件工程', '计算机科学yu技术');
INSERT INTO `student` VALUES ('student', '220004', '320683200110300603', '小文', 'Ww111', '19850336668', 'wwen75421@qq.com', 'studying', '软件工程', '计算机科学yu技术');
INSERT INTO `student` VALUES ('student', '220005', '421798200207253765', '旺仔', '123456', '', '', 'studying', '保密技术', '计算机科学yu技术');
INSERT INTO `student` VALUES ('student', '220006', '421798200207253764', '旺仔', '123456', '', '', 'studying', '保密技术', '计算机科学yu技术');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES ('teacher', '20000001', '410622197912093492', '朱东东', '123456', '17318271111', 'zdd@fudan.edu.cn', 'working', '计算机科学与技术', '计算机科学yu技术');
INSERT INTO `teacher` VALUES ('teacher', '20000002', '354683199008097640', '彭小新', '123456', '18958772236', 'pxx@163.com', 'working', '计算机科学与技术', '计算机科学yu技术');
INSERT INTO `teacher` VALUES ('teacher', '20000003', '276408200207252211', '马丁', '123456', '13127686548', 'Martin@fudan.edu.cn', 'quit', '计算机科学与技术', '计算机科学yu技术');
INSERT INTO `teacher` VALUES ('teacher', '20000004', '321622197912093492', '朱东', '123456', '17318222222', 'zd@fudan.edu.cn', 'quit', '计算机科学与技术', '计算机科学yu技术');
INSERT INTO `teacher` VALUES ('teacher', '20000006', '211298200110034567', '三胖', '123456', '', '', 'working', '软件工程', '计算机科学yu技术');
INSERT INTO `teacher` VALUES ('teacher', '20000009', '410622197912093493', '东东', '123456', '17318271111', 'zdd@fudan.edu.cn', 'working', '计算机科学与技术', '计算机科学yu技术');
