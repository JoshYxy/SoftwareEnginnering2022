...
public class TransUtil {
    ...
    public CoursepartPO CpDTOtoCpPO(CoursepartDTO coursepartDTO){
        ...
        Integer collegeId = xxx.(coursepartDTO.getCollegeName())// TODO: 2022/4/30 根据学院名查询学院id ;
    ...
    public CoursepartDTO CpPOtoCpDTO(CoursepartPO coursepartPO){
        ...
        //根据老师工号查询老师姓名并且插入
        String teacherName = xxx.(coursepartPO.getTeacherNum())// TODO: 2022/4/30 根据老师工号查询老师名;
    ...
    public CoursepartDTO ReqCpPOtoCpDTO(ReqCoursepartPO reqCoursepartPO){
        ...
        //根据老师工号查询老师姓名并且插入
        String teacherName = xxx.(reqCoursepartPO.getTeacherNum())// TODO: 2022/4/30 根据老师工号查询老师名;
        coursepartDTO.setTeacherName(teacherName);
    ...
    public TimepartPO TpDTOtoTpPO(TimepartDTO timepartDTO){
        ...
        Integer roomId = xxx.(timepartDTO.getBuilding(),timepartDTO.getRoomNum())// TODO: 2022/4/30 根据楼简称和教室号查教室id;
    ...
    public MajorPO MajorDTOtoPO(MajorDTO majorDTO){
        ...
        Integer collegeId = xxx.(majorDTO.getCollegeName())// TODO: 2022/4/30 根据collegeName查询collegeId; 
    ...
    public ReqTeacherPO RequestDTOtoPO(RequestDTO requestDTO){
        ...
        //根据楼名缩写和教室号查到教室id，并且插入
        Integer roomId = xxx.(requestDTO.getBuilding(),requestDTO.getRoomNum())// TODO: 2022/4/30 根据楼简称和教室号查教室id;
