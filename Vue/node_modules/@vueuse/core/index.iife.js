...
;(function (exports, shared, vueDemi, core) {
  ...
  function useDraggable(target, options = {}) {
    ...
    return __spreadProps$5(__spreadValues$b({}, shared.toRefs(position)), {
      position,
  ...
  function useInfiniteScroll(element, onLoadMore, options = {}) {
    var _a;
    const state = vueDemi.reactive(useScroll(element, __spreadProps$3(__spreadValues$8({}, options), {
  ...
  function useOffsetPagination(options) {
    const {
      ...
      pageSize = 10,
      page = 1,
      onPageChange = core.noop,
      onPageSizeChange = core.noop,
      onPageCountChange = core.noop
    } = options;
    const currentPageSize = core.useClamp(pageSize, 1, Infinity);
    const pageCount = vueDemi.computed(() => Math.ceil(vueDemi.unref(total) / vueDemi.unref(currentPageSize)));
    const currentPage = core.useClamp(page, 1, pageCount);
    ...
    if (vueDemi.isRef(page))
      core.biSyncRef(page, currentPage);
    if (vueDemi.isRef(pageSize))
      core.biSyncRef(pageSize, currentPageSize);
    function prev() {
      currentPage.value--;
    }
    function next() {
