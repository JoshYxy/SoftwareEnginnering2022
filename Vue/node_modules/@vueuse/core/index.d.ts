...
import { Fn, MaybeRef, Awaitable, ConfigurableEventFilter, ConfigurableFlush, RemovableRef, EventHookOn, IntervalFnOptions, Pausable, EventHook } from '@vueuse/shared';
 ...
 * @param elRef
 */
declare function unrefElement(elRef: MaybeElementRef): HTMLElement | SVGElement | undefined;
...
declare const StorageSerializers: Record<'boolean' | 'object' | 'number' | 'any' | 'string' | 'map' | 'set', Serializer<any>>;
...
interface FocusOptions extends ConfigurableWindow {
    /**
 ...
 * @param options
 */
declare function useFocus(options?: FocusOptions): FocusReturn;
...
interface UseTextSelectionState extends Rect {
    text: string;
}
declare function useTextSelection(element?: MaybeRef<HTMLElement | Document | null | undefined>): vue_demi.Ref<{
    text: string;
