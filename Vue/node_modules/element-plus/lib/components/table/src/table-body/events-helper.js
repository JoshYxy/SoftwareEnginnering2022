...
function useEvents(props) {
  ...
  const handleMouseEnter = lodashUnified.debounce(function(index) {
    props.store.commit("setHoverRow", index);
  }, 30);
  const handleMouseLeave = lodashUnified.debounce(function() {
  ...
  const handleCellMouseEnter = (event, row) => {
    ...
    const padding = (parseInt(style.getStyle(cellChild, "paddingLeft"), 10) || 0) + (parseInt(style.getStyle(cellChild, "paddingRight"), 10) || 0);
