  ...
  return vue.defineComponent({
    ...
    setup(props, { emit, expose, slots }) {
      ...
      const states = vue.ref({
        isScrolling: false,
        scrollLeft: core.isNumber(props.initScrollLeft) ? props.initScrollLeft : 0,
        scrollTop: core.isNumber(props.initScrollTop) ? props.initScrollTop : 0,
      ...
      const windowStyle = vue.computed(() => {
        ...
        return [
          ...
          },
          {
            ...
            height: core.isNumber(props.height) ? `${props.height}px` : props.height,
            width: core.isNumber(props.width) ? `${props.width}px` : props.width
          },
      ...
      const scrollToItem = (rowIndex = 0, columnIdx = 0, alignment = defaults.AUTO_ALIGNMENT) => {
        ...
        const scrollBarWidth = scroll.getScrollBarWidth();
