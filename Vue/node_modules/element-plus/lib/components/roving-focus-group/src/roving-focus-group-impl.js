...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    vue.onMounted(() => {
      ...
      event.on(rovingFocusGroupEl, ENTRY_FOCUS_EVT, handleEntryFocus);
    });
    vue.onBeforeUnmount(() => {
      const rovingFocusGroupEl = vue.unref(rovingFocusGroupRef);
      event.off(rovingFocusGroupEl, ENTRY_FOCUS_EVT, handleEntryFocus);
    });
  }
});
...
var ElRovingFocusGroupImpl = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["render", _sfc_render]]);
