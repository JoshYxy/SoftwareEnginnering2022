...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("ul", {
    ...
    _ctx.showPrevMore ? (vue.openBlock(), vue.createElementBlock("li", {
      key: 1,
      class: vue.normalizeClass(["more", "btn-quickprev", _ctx.nsIcon.b(), { disabled: _ctx.disabled }]),
    ...
    _ctx.showNextMore ? (vue.openBlock(), vue.createElementBlock("li", {
      key: 2,
      class: vue.normalizeClass(["more", "btn-quicknext", _ctx.nsIcon.b(), { disabled: _ctx.disabled }]),
...
var Pager = /* @__PURE__ */ pluginVue_exportHelper["default"](_sfc_main, [["render", _sfc_render]]);
