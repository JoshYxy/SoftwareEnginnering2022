...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const dialog = useDialog.useDialog(props, { emit }, dialogRef);
    const {
      visible,
      afterEnter,
      afterLeave,
    ...
    vue.provide(token.elDialogInjectionKey, {
      dialogRef,
      headerRef,
      ns,
      rendered,
    ...
    const overlayEvent = index$1.useSameTarget(dialog.onModalClick);
