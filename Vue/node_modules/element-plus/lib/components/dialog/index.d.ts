export declare const ElDialog: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly beforeClose: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<(...args: any[]) => void>, unknown, unknown, unknown, unknown>;
    ...
    emit: ((event: "update:modelValue", value: boolean) => void) & ((event: "close") => void) & ((event: "open") => void) & ((event: "opened") => void) & ((event: "closed") => void) & ((event: "openAutoFocus") => void) & ((event: "closeAutoFocus") => void);
    ns: {
