...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", {
    ...
    _ctx.showPrevMore ? (openBlock(), createElementBlock("li", {
      key: 1,
      class: normalizeClass(["more", "btn-quickprev", _ctx.nsIcon.b(), { disabled: _ctx.disabled }]),
    ...
    _ctx.showNextMore ? (openBlock(), createElementBlock("li", {
      key: 2,
      class: normalizeClass(["more", "btn-quicknext", _ctx.nsIcon.b(), { disabled: _ctx.disabled }]),
